...
public class UnitPositionManager : MonoBehaviour {
	...
	void Start () {
		...
		Vector3 OldMinPosition = new Vector3(renderer.bounds.min.x, renderer.bounds.min.y, renderer.bounds.min.z);
		Vector3 OldMaxPosition = new Vector3(renderer.bounds.max.x, renderer.bounds.max.y, renderer.bounds.max.z);
		Vector3 NewMinPosition = new Vector3(renderer.bounds.min.x, renderer.bounds.min.y, renderer.bounds.min.z);
		Vector3 NewMaxPosition = new Vector3(renderer.bounds.max.x, renderer.bounds.max.y, renderer.bounds.max.z);
